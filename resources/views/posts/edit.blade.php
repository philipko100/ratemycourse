...
@section('content')
    ...
    {!! Form::open(['action' => ['PostsController@update', $post->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        ...
        <select name = "rating" class="custom-select">
                <option value = "{{$post->rating}}" selected>{{$post->rating}}</option>
            ...
            <div class="form-group">
                    ...
                    {{Form::text('prof_firstname', $post->prof_firstname, ['class'=>'form-control', 'placeholder'=>'e.g. Jonathan'])}}
            </div>
            <div class="form-group">
                    {{Form::label('prof_lastname', 'Prof\'s Last Name')}}
                    {{Form::text('prof_lastname', $post->prof_lastname, ['class'=>'form-control', 'placeholder'=>'e.g. Topley'])}}
            </div>
        ...
        <br><br>
            ...
            <div class="form-group">
                    ...
                    {{Form::text('school', $post->school, ['class'=>'form-control', 'placeholder'=>'e.g. University of British Columbia'])}}
            </div>
        -->
        School
